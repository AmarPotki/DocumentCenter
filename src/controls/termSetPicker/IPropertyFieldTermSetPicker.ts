 ...
 * Selected terms
 */
export interface ICheckedTermSet {
...
export interface ICheckedTermSets extends Array<ICheckedTermSet> { }
...
export interface IPropertyFieldTermSetPickerProps {
   ...
   */
  initialValues?: ICheckedTermSets;
  /**
   ...
   *
   */
  onGetErrorMessage?: (value: ICheckedTermSets) => string | Promise<string>;
  /**
