    ...
    class Tools {
        ...
        */
        public constructor(apiKey: string) {
            ...
            this.apiKey = apiKey;
            try {
                if (typeof (<any>window).AudioContext !== 'undefined' || typeof (<any>window).webkitAudioContext !== 'undefined') {
    ...
    export class RecognitionClient {
        ...
        */
        ...
        public startMicAndContinuousRecognition() {
            if (typeof (<any>window).VADRecord !== "undefined") {
                if (!this._continuous) {
        ...
        private _startVoiceDetection(stream: MediaStream) {
            ...
            this._vad = new (<any>window).VADRecord(options);
        }
    ...
    export class TTSClient {
        ...
        */
        ...
        private makeSSML(text: string, localeAsked: SupportedLocales): string {
            ...
            SSML += locale + "><voice xml:lang=" + locale + " xml:gender=" + gender + " name='" + supportedLocaleValue + "'>" + `${this.encodeHtml(text)}` + "</voice></speak>";
            return SSML;
        }
...
((window) => {
    ...
    (<any>window).VADRecord = VADRecord;
